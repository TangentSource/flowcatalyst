...
public class PanacheAggregateRegistry {
    ...
    private void persistApplicationClientConfig(ApplicationClientConfig config) {
        String sql = """
            ...
            VALUES (:id, :applicationId, :clientId, :enabled, :baseUrlOverride,
                :websiteOverride, :configJson, :createdAt, :updatedAt)
            ON CONFLICT (id) DO UPDATE SET
    ...
    private void persistSubscription(Subscription sub) {
        String sql = """
            ...
            VALUES (:id, :code, :name, :description, :clientId, :clientIdentifier,
                :eventTypes::jsonb, :target, :queue, :customConfig::jsonb, :source, :status, :maxAgeSeconds,
    ...
    private void persistPrincipal(Principal principal) {
        ...
        em.createNativeQuery(sql)
            ...
            .setParameter("roles", toJson(principal.roles))
    ...
    private void persistOAuthClient(OAuthClient client) {
        String sql = """
            ...
            ON CONFLICT (id) DO UPDATE SET
                ...
                redirect_uris = EXCLUDED.redirect_uris, allowed_origins = EXCLUDED.allowed_origins,
                grant_types = EXCLUDED.grant_types, default_scopes = EXCLUDED.default_scopes,
                pkce_required = EXCLUDED.pkce_required, application_ids = EXCLUDED.application_ids,
        ...
        em.createNativeQuery(sql)
            ...
            .setParameter("redirectUris", client.redirectUris != null ? client.redirectUris.toArray(new String[0]) : new String[0])
            .setParameter("allowedOrigins", client.allowedOrigins != null ? client.allowedOrigins.toArray(new String[0]) : new String[0])
            .setParameter("grantTypes", client.grantTypes != null ? client.grantTypes.toArray(new String[0]) : new String[0])
            .setParameter("defaultScopes", client.defaultScopes)
            .setParameter("pkceRequired", client.pkceRequired)
            .setParameter("applicationIds", client.applicationIds != null ? client.applicationIds.toArray(new String[0]) : new String[0])
