 ...
 * Roles are stored as JSONB array.
 */
...
/**
 * Role assignment stored in JSONB roles array.
 */
export interface RoleAssignmentJson {
	roleName: string;
...
export const principals = pgTable(
	'principals',
	{
		...
		// Role assignments as JSONB array
		roles: jsonb('roles').$type<RoleAssignmentJson[]>().default([]),
	},
	(table) => [
