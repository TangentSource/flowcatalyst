    ...
    public <T> ParamConverter<T> getConverter(Class<T> rawType, Type genericType, Annotation[] annotations) {
        ...
        return (ParamConverter<T>) new ParamConverter<String>() {
            ...
            public String fromString(String value) {
                ...
                // Deserialize: strip prefix and validate
                return typedId.deserialize(entityType, value);
            }
            ...
            public String toString(String value) {
                ...
                // Serialize: add prefix (for completeness, though rarely used)
                return TypedId.Ops.serialize(entityType, value);
            }
        };
    }
}
